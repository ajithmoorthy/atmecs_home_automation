...
public class HomePage {
	...
	public void pageValidation(WebDriver driver,Properties prop,String title,String breadcrumb,int index) throws InterruptedException {
		driver.manage().window().maximize();
		String locstring=prop.getProperty("loc.btn.moreinfo1").replace("aaaa", index+"");
		help.scrollPage(driver,locstring);
		help.clickElement(locstring, driver);
